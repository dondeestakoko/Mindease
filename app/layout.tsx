...
export const metadata: Metadata = {
  title: "MindEase - Gestion du Stress Étudiant",
  description: "Application pour aider les étudiants à gérer leur stress et leur bien-être",
}
        ...
        <nav className="bg-blue-600 p-4">
          <div className="container mx-auto flex justify-between items-center">
            ...
            <div className="space-x-4">
              ...
              <Link href="/trends" className="text-white hover:text-blue-200">
                Tendances
              </Link>
              <Link href="/recommendations" className="text-white hover:text-blue-200">
                Recommandations
              </Link>
            </div>
          </div>
